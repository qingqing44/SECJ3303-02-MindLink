<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    ...
    <head>
        ...
        <style>
            ...
            .hero-container {
                ...
                padding: 0 20px;
                overflow: hidden;
                /* Prevent scrollbars from shapes */
            }
    ...
    <body>
        ...
        <div class="hero-container">
            ...
            <img src="${pageContext.request.contextPath}/images/assessment-left.png" class="shape-left" alt="">
            ...
            <img src="${pageContext.request.contextPath}/images/assessment-right.png" class="shape-right" alt="">
